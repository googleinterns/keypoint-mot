...
class VideosIndexer:
    ...
    def get_video_frame(self, absolute_frame_idx: int):
        """
        ...
        if video_idx >= len(self.video_lengths):
            raise ValueError
