...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--not_show_number', action='store_true', default=False)
        ...
        self.parser.add_argument('--show_trace', action='store_true', default=True)
    ...
    def parse(self, args=''):
        ...
        opt.data_dir = os.path.join('/home/vasilup_google_com/datasets')
    ...
    def init(self, args=''):
        ...
        opt = self.parse()
        from dataset.dataset_factory import DATASETS as dataset_factory
